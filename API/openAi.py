# python openAi.py --model gpt-3.5-turbo --api_key sk-6ixzGDyBvnfLvbERupyjPOWRYhFp0otNDmxUZHUZD9P7TyFy --base_url https://api.chatanywhere.tech/v1
# python openAi.py --model deepseek-v3.2 --api_key sk-6ixzGDyBvnfLvbERupyjPOWRYhFp0otNDmxUZHUZD9P7TyFy --base_url https://api.chatanywhere.tech/v1

# python openAi.py --model deepseek-chat --api_key sk-3a0f1eb760874f1287abd43b7008c42a --base_url https://api.deepseek.com 
